...
private:
    ...
    bool is_goal_to_grey = false;
    bool is_goal_to_brown = false;
...
public:
    ...
    bool const  get_entrance()     const { return is_entrance; };
    bool const  get_goal_to_grey()         const { return is_goal_to_grey; };
    bool const  get_goal_to_brown()        const { return is_goal_to_brown; };
};